...
import { getRaceResults, type Race } from "../services/api";
import {
  formatRaceDate,
  formatDriverName,
  getCountryFlag,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="mb-6 lg:mb-0">
                  <div className="flex items-center mb-4">
                    <div className="bg-gradient-to-r from-red-500 to-yellow-500 text-white px-6 py-2 rounded-full text-sm font-black mr-4 ">
                      ROUND {race.round}
                    </div>
        ...
        {(winner || fastestLapDriver) && (
          ...
          >
            {winner && (
              <div className="group relative bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 backdrop-blur-sm border border-white/20 rounded-3xl p-8 overflow-hidden ">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/20 to-yellow-500/20 opacity-0 "></div>

                <div className="relative">
                  <div className="flex items-center mb-4">
                    <div className="p-3 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl mr-4 ">
            ...
            {fastestLapDriver && (
              <div className="group relative bg-gradient-to-br from-purple-500/20 to-purple-700/20 backdrop-blur-sm border border-white/20 rounded-3xl p-8 overflow-hidden ">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-400/20 to-purple-600/20 opacity-0 "></div>

                <div className="relative">
                  <div className="flex items-center mb-4">
                    <div className="p-3 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl mr-4 ">
